...
export default function AddArea({ showModal, handleShow, sectors, setSectorID, loader, setLoader, getText, submitArea })
{
    ...
    return (
        <Modal show={showModal} onHide={handleShow} size="md" aria-labelledby="contained-modal-title-vcenter" centered >
            <Modal.Header>
                <Modal.Title className="text-center">Add Area</Modal.Title>
            ...
            <Modal.Body>
                {
                        ...
                        <>
                            <div className="text-center d-flex flex-column mb-2">
                                ...
                                <div className="d-flex flex-row text-left mt-3">
                                            ...
                                            <div className="col-8">
                                                <select className="form-control" id="sector-name" defaultValue="0" onChange={(e)=>{toggleBtn(e); setSectorID(e.target.value)}}>
                    ...
                    :
                        <div className="d-flex flex-column text-center plane-loader">
                            ...
                            <h3>Please Wait... We are Adding New Area</h3>
                        </div>
                }
            </Modal.Body>
        </Modal>
