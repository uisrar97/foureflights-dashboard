...
export default function AddContinent({ showModal, handleShow, loader, setLoader, getText, submitContinent })
{
    ...
    return (
        <Modal show={showModal} onHide={handleShow} size="md" aria-labelledby="contained-modal-title-vcenter" centered >
            <Modal.Header>
                <Modal.Title className="text-center">Add Continent</Modal.Title>
