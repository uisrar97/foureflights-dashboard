...
export default function EditRegion({ showModal, handleShow, loader, setLoader, getText, submitSector, regions, setRegionID, data })
{
    ...
    return (
        <Modal show={showModal} onHide={handleShow} size="md" aria-labelledby="contained-modal-title-vcenter" centered >
            <Modal.Header>
                <Modal.Title className="text-center">Edit City</Modal.Title>
            ...
            <Modal.Body>
                {
                        ...
                        <>
                            <div className="text-center d-flex flex-column mb-2">
                                ...
                                <div className="d-flex flex-row text-left mt-3">
                                            ...
                                            <div className="col-8">
                                                <select className="form-control" id="region-name" defaultValue={data.region_id} onChange={(e)=>{toggleBtn(e); setRegionID(e.target.value)}}>
                    ...
                    :
                        <div className="d-flex flex-column text-center plane-loader">
                            ...
                            <h3>Please Wait... We are Updating City</h3>
                        </div>
                }
            </Modal.Body>
        </Modal>
